                    ...
                    <Col>
                        <div className='d-flex justify-content-between align-items-end'>
                            <div className='w-75'>
                                ...
                                <h2 className='py-2'>Featured Properties</h2>
                                <p className={featuredStyles.featuredesctext}>Explore our handpicked selection of featured properties. Each listing offers a glimpse into exceptional homes and investments available through Estatein. Click "View Details" for more information.</p>
                            </div>
                            <div>
                                <Button variant="dark" className={featuredStyles.viewallbtn}>View All Properties</Button>
                            </div>
                        </div>
                    </Col>
                </Row>
