...
import propertiesdiscoverStyles from '@/app/components/properties_discover.module.css'
...
const properties_discover = () => {
    ...
    const slidesData = [
        ...
        },
        {
            ...
            price: '$350,000',
            text: 'Countryside Charm - Escape to Nature\'s Embrace',
        },
        {
            id: 4,
            img: featuredimg1,
                ...
                <Row>
                    <Col>
                        <div className='d-flex justify-content-between align-items-end'>
                            <div className={`${propertiesdiscoverStyles.secdesc}`}>
                                ...
                                <h2 className={`${propertiesdiscoverStyles.properties_discover_title} py-2`}>Discover a World of Possibilities</h2>
                                <p className={propertiesdiscoverStyles.featuredesctext}>Our portfolio of properties is as diverse as your dreams. Explore the following categories to find the perfect property that resonates with your vision of home</p>
                            </div>
                        </div>
                        <div className={`${propertiesdiscoverStyles['slider-container']} py-4`} id='featured-slider'>
                            <Slider {...settings} ref={slider => {
                                sliderRef = slider;
                            }}>
                                {slidesData.map((item, index) => <Card key={index} className={propertiesdiscoverStyles.slidercard}>
                                    <Card.Body>
                                        <div>
                                            <Image src={item.img} width='auto' height='auto' alt={item.img} className='mb-3 img-fluid w-100' />
                                            <div className='py-3'>
                                                <span className={propertiesdiscoverStyles.amenitiesbg}>{item.text}</span>
                                            </div>
                                            <h5>{item.title}</h5>
                                            <p>{item.desc}</p>
                                        </div>
                                        ...
                                        <div className='d-flex justify-content-between align-items-center pt-2'>
                                            ...
                                            <div>
                                                <Button variant='dark' className={propertiesdiscoverStyles.sliderdetailsbtn}>View Property Details</Button>
                                            </div>
                                        </div>
                                    </Card.Body>
                                </Card>
                        ...
                        <div className='d-lg-flex d-none align-items-lg-center justify-content-lg-between pt-3'>
                            <div>
                                <p>
                                    {currentSlide + 1} of {slidesData.length}
                                </p>
                            </div>
                            <div>
                                <Button variant='dark' className={propertiesdiscoverStyles.sliderarrowsbtn} onClick={previous}>
                                ...
                                <Button variant='dark' className={propertiesdiscoverStyles.sliderarrowsbtn} onClick={next}>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default properties_discover